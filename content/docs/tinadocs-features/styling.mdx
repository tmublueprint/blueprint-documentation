...
<imageEmbed image={{ src: "/img/docs-assets/choose-starter-screen.png", alt: "TinaDocs theme selection screen showing six colour presets", width: 2245, height: 1587 }} caption="Choose your starter" />
